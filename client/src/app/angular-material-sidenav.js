...
(function(window, angular, undefined) {
    ...
    .run(['$templateCache', function($templateCache) {
        $templateCache.put('views/ss/menu-link.tmpl.html',
            '<md-button\n' +
            '   ss-style-color="{\'background-color\': (isSelected(section.state) || $state.includes(section.state)) ? \'accent.800\': \'accent.default\'}"' +
            '   class="md-raised md-primary"' +
            '   ui-sref="{{section.state}}"\n' +
            '   ng-click="focusSection(section)">\n' +
            '   <ng-md-icon ng-if="section.icon" icon="{{section.icon}}" size="20"></ng-md-icon> '+
        ...
        $templateCache.put('views/ss/menu-toggle.tmpl.html',
            '<md-button class="md-raised md-accent md-button-toggle"\n' +
            ...
            '            <ng-md-icon icon="keyboard_arrow_up" style="fill: ..." size="20"></ng-md-icon>\n' +
            '       </span>\n' +
            '   </div>\n' +
            '   <span class="md-visually-hidden">\n' +
        ...
        $templateCache.put('views/ss/menu-sidenav.tmpl.html',
            '<ul class="menu">' +
            '    <li ss-style-color="{\'border-bottom-color\': \'accent.600\'}" ng-repeat="section in menu.sections" ng-if="!section.hidden">' +
